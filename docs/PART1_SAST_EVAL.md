...
2. The CodeQL XSS result demonstrates why scanner findings require manual review: custom sanitization can produce a false positive when it is not modeled by the analyzer. Even with better data-flow analysis there could still be false positive
